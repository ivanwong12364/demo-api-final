...
exports.validateHotel = exports.validateUser = exports.validateArticle = void 0;
...
const validateHotel = (ctx, next) => __awaiter(void 0, void 0, void 0, function* () {
    const validationOptions = {
        throwError: true,
        allowUnknownAttributes: false
    };
    const body = ctx.request.body;
    try {
        v.validate(body, hotel_schema_1.hotel, validationOptions);
        yield next();
    }
    catch (error) {
        if (error instanceof jsonschema_1.ValidationError) {
