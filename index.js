...
var hotels_1 = require("./routes/hotels"); // Ensure this path is correct
...
app.use(function (ctx, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                err_1 = _a.sent();
                ctx.body = { err: err_1.message || err_1 };
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
}); });
var port = process.env.PORT || 10888;
app.listen(10888, function () {
    console.log("Koa Started at ".concat(port));
});
